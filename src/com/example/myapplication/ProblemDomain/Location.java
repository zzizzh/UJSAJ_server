...
public class Location implements Serializable {
	...
	public String toString() {
		return "Location{" + "bigLocation='" + bigLocation + '\'' + ", midLocation='" + midLocation + '\''
				+ ", smallLocation='" + smallLocation + '\'' + ", contentID=" + contentID + ", contentTypeID="
				+ contentTypeID + ", title='" + title + '\'' + ", firstimage='" + firstimage + '\'' + ", mapX=" + mapX
				+ ", mapY=" + mapY + '}';
	}
}